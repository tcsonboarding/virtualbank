...
import com.digid.bfsi.trainings.virtualbank.billpay.service.VendorService;
...
public class VendorController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/bills/{vendorId}")
    ...
    @ApiOperation(value = "Delete vendor by vendorId", response = String.class, httpMethod = "GET")
